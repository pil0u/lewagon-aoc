...
class UpdateCompletionsVirtualColumns2024 < ActiveRecord::Migration[7.1]
  # Inspired by AddDerivedDataToCompletions
  BEGINNING_OF_EXERCISES = ActiveSupport::TimeZone["EST"].local(2024, 12, 1, 0, 0, 0).freeze
