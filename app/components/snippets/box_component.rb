...
module Snippets
  class BoxComponent < ApplicationComponent
    ...
    def initialize(snippet:, user:)
      ...
      @discuss_confirm = "By clicking this button, you will create a new Slack thread on #aoc and notify the author of the solution. Do you want to proceed?" if @snippet.slack_url.nil?
    end
  end
end
