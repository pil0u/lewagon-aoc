...
RSpec.describe Cache::Clean do
  let!(:existing_cache) {
    ...
    Cache::SoloPoint.insert_all([
      ...
      { day: 1, challenge: 1, score: 20, user_id: 1, cache_fingerprint: 'B', created_at: "2022-12-01 23:00:00 UTC" },
      { day: 1, challenge: 1, score: 20, user_id: 2, cache_fingerprint: 'B', created_at: "2022-12-01 23:00:00 UTC" },
      ...
      { day: 2, challenge: 1, score: 20, user_id: 1, cache_fingerprint: 'B', created_at: "2022-12-02 23:00:00 UTC" },
      { day: 2, challenge: 1, score: 20, user_id: 2, cache_fingerprint: 'B', created_at: "2022-12-02 23:00:00 UTC" },
    ])
  }
