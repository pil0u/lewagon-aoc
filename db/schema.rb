...
ActiveRecord::Schema[7.2].define(version: 2025_11_27_101604) do
  ...
  create_table "completions", force: :cascade do |t|
    ...
    t.virtual "duration", type: :interval, as: "\nCASE\n    WHEN (completion_unix_time IS NOT NULL) THEN (to_timestamp((completion_unix_time)::double precision) - to_timestamp(((1764565200)::double precision + (((day - 1) * 86400))::double precision)))\n    ELSE NULL::interval\nEND", stored: true
    t.virtual "release_date", type: :datetime, precision: nil, as: "to_timestamp(((1764565200)::double precision + (((day - 1) * 86400))::double precision))", stored: true
    t.bigint "user_id", null: false
